...
%   por meio de questionários e entrevistas.
  ...
  INTRODUZIR O PLANEJAMENTO DE UMA AVALIAÇÃO (Dizendo a importância e tudo mais)
  E APRESENTAR AQUI O CONCEITO DO FRAMEWORK 'DECIDE' E DEMAIS CONCEITOS QUE SE FIZEREM NECESSÁRIO.
  
  \textbf{COM REFERÊNCIAS!!!}
  ...
  \section{Estudos dos questionários}
	...
	COLOCAR AQUI O PLANEJAMENTO DA PRIMEIRA ITERAÇÃO DE AVALIAÇÃO DO PROTÓTIPO DE PAPEL.
	
      \subsection{Iteração 2}
	
	COLOCAR AQUI O PLANEJAMENTO DA SEGUNDA ITERAÇÃO DE AVALIAÇÃO DO PROTÓTIPO DE PAPEL.
