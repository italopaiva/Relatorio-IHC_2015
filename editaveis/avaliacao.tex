\chapter{Resultado das Avaliações}
  ...
  \section{Avaliações do protótipo de alta fidelidade}
    ...
    Possuem como objetivo avaliar as características do protótipo da aplicação, em sua versão para Desktop, no 
	...
	\item 19/06/2015 – Colour Contrast Analyser
    \end{itemize}
    ...
    Após a avaliação, a ferramenta informa os erros presentes no código HTML do
    ...
    Não foram utilizados os elementos “label” e “id” para associar os rótulos aos 
    ...
    necessidade de algumas correções na estrutura do código HTML,  para que quando 
    interpretada por um software de leitura de tela a página possa ser plenamente funcional.